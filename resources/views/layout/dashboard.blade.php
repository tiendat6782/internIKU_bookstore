                        ...
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    ...
                                    <h5 class="font-weight-bolder mb-0">
                                        +{{ $data_header[4] }}
                                        <span class="text-danger text-sm font-weight-bolder">+ {{ $data_header[2] }}</span>
                                    </h5>
                                </div>
                            </div>
                            <div class="col-4 text-end">
                        ...
                        <div class="container border-radius-lg">
                            <div class="row">
                                <div class="col-3 py-3 ps-0">
                                    ...
                                    <h4 class="font-weight-bolder">{{ $data_header[4] }}</h4>
                                ...
                                <div class="col-4 py-3 ps-0">
                                    ...
                                    <h4 class="font-weight-bolder">{{ $chart1[2] }}</h4>
                                    <div class="progress w-75">
                ...
                <div class="card z-index-2">
                    <div class="card-header pb-0">
                        ...
                        <p class="text-sm">
                            ...
                            <span class="font-weight-bold"> in 2023</span>
                        </p>
                    </div>
                    <div class="card-body p-3">
                        <div class="chart">
        ...
        <div class="col-lg-12">
            <div class="card z-index-2">
                <div class="card-header pb-0">
                    ...
                    <p class="text-sm">
                        <i class="fa fa-arrow-up text-success"></i>
                        <span class="font-weight-bold">{{ $data_header[3] }} VND</span> 
                    </p>
                </div>
                <div class="card-body p-3">
                    <div class="chart">
