                                ...
                                <tbody>
                                    @foreach ($books as $item)
                                        <tr>
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    ...
                                                    <div class="d-flex flex-column justify-content-center">
                                                        <h6 class="mb-0 text-sm text-truncate" style="max-width: 200px;">{{ $item->name }}</h6>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td class="align-middle  text-sm">
                                                <p class="text-xs text-secondary mb-0">{{ $item->soLuong }}</p>
                                            </td>
                                            <td class="align-middle  text-sm">
                                            ...
                                            <td class="align-middle text-center">
                                                <a href="{{ route('edit_book', ['id' => $item->id]) }}"
                                                ...
                                                <a onclick="return confirm('Are you sure ?')"
                                                    href="{{ route('delete_book', ['id' => $item->id]) }}"
