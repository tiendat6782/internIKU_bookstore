...
@section('content')
    <div class="container-fluid my-5 p-2 bg-white border border-2 border-white rounded-2">
        <form class="row g-3" action="{{ route('edit_khuyenmai',['id'=>$khuyenmai->id]) }}" method="POST">
            @csrf
            <div class="col-md-6">
                <label for="inputname4" class="form-label">Name</label>
                <input type="text" class="form-control" id="inputname4" name="name" value="{{$khuyenmai->name}}">
                @if ($errors->has('name'))
            ...
            <div class="col-md-6">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="inputcode4" name="code" value="{{$khuyenmai->code}}" aria-describedby="basic-addon1">
                </div>
                @if ($errors->has('code'))
            ...
            <div class="col-md-6 d-flex align-items-start">
                <div class="col-md-12">
                    ...
                    <input type="range" class="form-range  bg-transpant" value="{{$khuyenmai->value}}" name="value" min="0" max="100"
                        step="5" id="myRange">
            ...
            <div class="col-md-6">
                ...
                <div class="input-group date" id="datepicker">
                    <input type="date" name="time" value="{{$khuyenmai->time}}" class="form-control" id="datetime" />
                </div>
            </div>
            <div class="col-md-6">
                <div class="mb-3">
                    <label for="" class="form-label">Note</label>
                    <textarea class="form-control" name="note" id="" rows="2">{{$khuyenmai->note}}</textarea>
                    @if ($errors->has('note'))
